...
public class MeterSearchRequest implements Serializable {
	...
	public MeterSearchRequest(long circleAutoid, String circleName, long divisionAutoid, String divisionName,
			...
			String transformerAutoid, String transformerName, String manufactureName, long yearofManufacture,
			String meterCategory, String firmWareVersion, String communicated, Date fromDate,
